...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Setup Wizard Navigation >> shows integrations step after clicking through
- Location: frontend/tests/e2e/setup-flow.spec.ts:166:3
