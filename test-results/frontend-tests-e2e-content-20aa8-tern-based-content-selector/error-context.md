...
- Name: frontend/tests/e2e/content-flow.spec.ts >> Content Flow >> should display pattern-based content selector
- Location: frontend/tests/e2e/content-flow.spec.ts:37:3
