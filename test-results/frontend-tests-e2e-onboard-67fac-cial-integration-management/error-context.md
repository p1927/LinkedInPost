...
- Name: frontend/tests/e2e/onboarding.spec.ts >> Settings Page >> should allow social integration management
- Location: frontend/tests/e2e/onboarding.spec.ts:56:3
