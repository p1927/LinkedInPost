    ...
    if gcs_bucket_name:
        ...
        if not bucket.cors:
            warn(
                ...
                'no CORS rules are configured. Standard image tags still work, but browser fetch-based media tooling may need bucket CORS entries for your frontend origins.',
            )
