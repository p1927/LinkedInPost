...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Setup Flow >> shows status dashboard when partial setup exists
- Location: frontend/tests/e2e/setup-flow.spec.ts:20:3
