...
export function getNewsProviderKeyStatus(env: ResearcherEnv): NewsProviderKeyStatus {
  return {
...
export function collectEnabledRssUrls(stored: NewsResearchStored, env: ResearcherEnv): string[] {
