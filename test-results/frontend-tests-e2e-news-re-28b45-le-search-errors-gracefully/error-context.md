...
- Name: frontend/tests/e2e/news-research.spec.ts >> News Research Feature >> should handle search errors gracefully
- Location: frontend/tests/e2e/news-research.spec.ts:37:3
