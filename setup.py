...
def sync_github_secrets(worker_bootstrap: WorkerBootstrap, google_resources: GoogleResources | None) -> None:
    ...
    secrets_to_sync: dict[str, str] = {
        ...
        'VERTEX_AI_SEARCH_LOCATION': os.environ.get('VERTEX_AI_SEARCH_LOCATION', '').strip(),
        'VERTEX_AI_SEARCH_ENGINE_ID': os.environ.get('VERTEX_AI_SEARCH_ENGINE_ID', '').strip() or os.environ.get('VERTEX_AI_SEARCH_APP_ID', '').strip(),
