...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Setup Flow >> shows progress during dependency installation
- Location: frontend/tests/e2e/setup-flow.spec.ts:38:3
