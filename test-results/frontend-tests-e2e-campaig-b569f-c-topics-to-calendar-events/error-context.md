...
- Name: frontend/tests/e2e/campaign.spec.ts >> Campaign Calendar Integration >> should sync topics to calendar events
- Location: frontend/tests/e2e/campaign.spec.ts:79:3
