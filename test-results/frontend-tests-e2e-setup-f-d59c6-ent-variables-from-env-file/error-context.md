...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Setup Detection >> detects environment variables from .env file
- Location: frontend/tests/e2e/setup-flow.spec.ts:52:3
