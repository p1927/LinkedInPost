...
- Name: frontend/tests/e2e/onboarding.spec.ts >> Connections Page >> should display connections page
- Location: frontend/tests/e2e/onboarding.spec.ts:69:3
...
Call log:
  - navigating to "/connections", waiting until "load"
