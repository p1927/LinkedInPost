...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Dry Run Mode >> action buttons trigger handlers without crashing
- Location: frontend/tests/e2e/setup-flow.spec.ts:286:3
