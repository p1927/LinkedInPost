...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Dry Run Mode >> quick actions are clickable without errors
- Location: frontend/tests/e2e/setup-flow.spec.ts:233:3
