...
- Name: frontend/tests/e2e/campaign.spec.ts >> Campaign Import >> should show validation errors for malformed data
- Location: frontend/tests/e2e/campaign.spec.ts:61:3
