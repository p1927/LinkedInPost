...
- Name: frontend/tests/e2e/scheduling.spec.ts >> Scheduling Operations >> should handle timezone considerations
- Location: frontend/tests/e2e/scheduling.spec.ts:47:3
