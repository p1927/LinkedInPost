...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Setup Wizard Navigation >> can proceed from welcome to directory selection
- Location: frontend/tests/e2e/setup-flow.spec.ts:146:3
