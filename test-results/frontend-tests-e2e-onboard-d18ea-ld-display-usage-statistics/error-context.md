...
- Name: frontend/tests/e2e/onboarding.spec.ts >> Usage Page >> should display usage statistics
- Location: frontend/tests/e2e/onboarding.spec.ts:91:3
...
Call log:
  - navigating to "/usage", waiting until "load"
