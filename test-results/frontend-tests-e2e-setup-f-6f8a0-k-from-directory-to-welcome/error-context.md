...
- Name: frontend/tests/e2e/setup-flow.spec.ts >> Setup Wizard Navigation >> can go back from directory to welcome
- Location: frontend/tests/e2e/setup-flow.spec.ts:153:3
