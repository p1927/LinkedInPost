...
- Name: frontend/tests/e2e/content-flow.spec.ts >> Content Review Feature >> should display content review workspace
- Location: frontend/tests/e2e/content-flow.spec.ts:4:3
